...
import { InformationInsurancePatientDataProps } from "../model/types"

const InformationInsurancePatientData = (props: InformationInsurancePatientDataProps) => {
  ...
  return (
    <Stack gap={2}>
      ...
      <Typography variant="h5" color="secondary.darker">Detail Data Asuransi Pasien</Typography>
...
export default InformationInsurancePatientData